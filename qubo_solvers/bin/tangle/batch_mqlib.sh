...
printf "\n\n"
echo "MQlib Solver"
bsub -J  "mqlibJobs[1-$jobs]" -R '"select[mem>'$memory'] rusage[mem='$memory']"' -M "$memory" -o "qubo_solvers/out/tangle/mqlib.$filename.%J.%I" -e "qubo_solvers/out/tangle/error.mqlib.$filename.%J" -G "qpg" "python3 qubo_solvers/tangle/max_path_mqlib.py $filepath $normalisation $time_limit"
