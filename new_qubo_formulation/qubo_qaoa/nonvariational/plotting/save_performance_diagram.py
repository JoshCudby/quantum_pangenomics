...
def plot_log_to_ax(ax, filename, maxdb, maxdg, maxr, maxp):
    ...
    eps = 1e-9
    logp = np.log10(probabilities.T + eps)   # shape (rescaling, p)
...
if __name__ == "__main__":
    filenames = ['test_N2_W2', 'trivial', 'test_N3_W4']
    subplot_titles = ['n = 8', 'n = 18', 'n = 24']
    db = 0.63
    dg = 0.16
    r = 3.16
    p = 316
    ...
    fig.suptitle(r'Performance diagrams for $\Delta_\beta = 0.63, \Delta_\gamma = 0.16$', fontsize=11, y=1.02)
