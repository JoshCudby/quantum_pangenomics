...
axs.plot([hist[1] + offset for hist in history])
...
alpha_qaoa = (min(sample_vals) - cplex_res_max.fval) / (min_val - cplex_res_max.fval)
alpha_rand = (min(rand_vals) - cplex_res_max.fval) / (min_val - cplex_res_max.fval)
