...
from qiskit_qaoa.utils.shortest_sequence_graph_reset import heuristic_spanning_tree_solver, bfs_shortest_sequence
...
class CommutingGateRouterPrecompute(TransformationPass):
    ...
    def _reset_info(
        ...
        seq = bfs_shortest_sequence(list(all_vertices_in_chain), edges, currently_stored_info, max_states=1000000)
        if seq is not None:
            for gate in seq:
