...
figname = f'/nfs/users/nfs_j/jc59/quantumwork/pangenome/new_hubo_formulation/out/param_exploration.db{np.round(delta_beta[-1], 2)}.dg{np.round(delta_gamma[-1],2)}.p{p_values[-1]}.png'
